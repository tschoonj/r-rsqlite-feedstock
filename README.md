...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-rsqlite-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-rsqlite-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-rsqlite-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-rsqlite-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-rsqlite-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-rsqlite-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-rsqlite/badges/version.svg)](https://anaconda.org/conda-forge/r-rsqlite)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-rsqlite/badges/downloads.svg)](https://anaconda.org/conda-forge/r-rsqlite)
